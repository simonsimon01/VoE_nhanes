...
# for measurement error in both variable of interest and adjustment variables
...
any_diabetes_me <- me_fun(data = mainTab, ord_var = data_ord, 
                              ...
                              me_type = "all", me_range = me_mix,
                              adj_var = adj_var, adj_type = adj_type, B = 1000, print_progress = T)

save(any_diabetes_me, file = "Results/measurement_real/any_diabetes_me.RData")
...
save(any_cad_me, file = "Results/measurement_real/any_cad_me.RData")
...
save(BMXTHICR_me, file = "Results/measurement_real/BMXTHICR_me.RData")
...
save(LBDHDL_me, file = "Results/measurement_real/LBDHDL_me.RData")
...
save(any_ht_me, file = "Results/measurement_real/any_ht_me.RData")
...
save(any_cancer_self_report_me, file = "Results/measurement_real/any_cancer_self_report_me.RData")
...
save(any_family_cad_me, file = "Results/measurement_real/any_family_cad_me.RData")
...
save(LBDNENO_me, file = "Results/measurement_real/LBDNENO_me.RData")
...
save(BMXCALF_me, file = "Results/measurement_real/BMXCALF_me.RData")
...
save(BMXHT_me, file = "Results/measurement_real/BMXHT_me.RData")
...
save(BMXWAIST_me, file = "Results/measurement_real/BMXWAIST_me.RData")
...
save(BMXWT_me, file = "Results/measurement_real/BMXWT_me.RData")
...
save(BPXPLS_me, file = "Results/measurement_real/BPXPLS_me.RData")
...
save(DSDCOUNT_me, file = "Results/measurement_real/DSDCOUNT_me.RData")
...
save(LBXHA_me, file = "Results/measurement_real/LBXHA_me.RData")
...
save(LBXHBC_me, file = "Results/measurement_real/LBXHBC_me.RData")
...
save(LBXHBS_me, file = "Results/measurement_real/LBXHBS_me.RData")
...
save(LBXLYPCT_me, file = "Results/measurement_real/LBXLYPCT_me.RData")
...
save(LBXMPSI_me, file = "Results/measurement_real/LBXMPSI_me.RData")
...
save(LBXSCA_me, file = "Results/measurement_real/LBXSCA_me.RData")
...
save(LBXSNASI_me, file = "Results/measurement_real/LBXSNASI_me.RData")
...
save(LBXSOSSI_me, file = "Results/measurement_real/LBXSOSSI_me.RData")
...
save(LBXSPH_me, file = "Results/measurement_real/LBXSPH_me.RData")
...
save(male_me, file = "Results/measurement_real/male_me.RData")
...
save(pest_control_home_last_month_me, 
     file = "Results/measurement_real/pest_control_home_last_month_me.RData")
...
save(pneu_me, file = "Results/measurement_real/pneu_me.RData")
...
save(private_water_source_me, file = "Results/measurement_real/private_water_source_me.RData")
...
save(use_water_treatment_me, file = "Results/measurement_real/use_water_treatment_me.RData")
...
RIDAGEYR_me <- me_fun(data = mainTab, ord_var = data_ord, voi = "RIDAGEYR", voi_type = "Num", 
                      me_type = "all", me_range = me_mix, adj_var = adj_var, adj_type = adj_type, 
                      B = 1000, print_progress = T)

save(RIDAGEYR_me, file = "Results/measurement_real/RIDAGEYR_me.RData")
...
save(SMD410_me, file = "Results/measurement_real/SMD410_me.RData")