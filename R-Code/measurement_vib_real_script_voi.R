...
# for measurement error in the variable of interest
...
any_diabetes_me <- me_fun(data = mainTab, ord_var = data_ord, 
                          ...
                          me_type = "voi", me_range = me_mix,
                          adj_var = adj_var, adj_type = adj_type, B = 1000, print_progress = T)

save(any_diabetes_me, file = "Results/measurement_real_voi/any_diabetes_me.RData")
...
save(any_cad_me, file = "Results/measurement_real_voi/any_cad_me.RData")
...
save(BMXTHICR_me, file = "Results/measurement_real_voi/BMXTHICR_me.RData")
...
save(LBDHDL_me, file = "Results/measurement_real_voi/LBDHDL_me.RData")
...
save(any_ht_me, file = "Results/measurement_real_voi/any_ht_me.RData")
...
save(any_cancer_self_report_me, file = "Results/measurement_real_voi/any_cancer_self_report_me.RData")
...
save(any_family_cad_me, file = "Results/measurement_real_voi/any_family_cad_me.RData")
...
save(LBDNENO_me, file = "Results/measurement_real_voi/LBDNENO_me.RData")
...
save(BMXCALF_me, file = "Results/measurement_real_voi/BMXCALF_me.RData")
...
save(BMXHT_me, file = "Results/measurement_real_voi/BMXHT_me.RData")
...
save(BMXWAIST_me, file = "Results/measurement_real_voi/BMXWAIST_me.RData")
...
save(BMXWT_me, file = "Results/measurement_real_voi/BMXWT_me.RData")
...
save(BPXPLS_me, file = "Results/measurement_real_voi/BPXPLS_me.RData")
...
save(DSDCOUNT_me, file = "Results/measurement_real_voi/DSDCOUNT_me.RData")
...
save(LBXHA_me, file = "Results/measurement_real_voi/LBXHA_me.RData")
...
save(LBXHBC_me, file = "Results/measurement_real_voi/LBXHBC_me.RData")
...
save(LBXHBS_me, file = "Results/measurement_real_voi/LBXHBS_me.RData")
...
save(LBXLYPCT_me, file = "Results/measurement_real_voi/LBXLYPCT_me.RData")
...
save(LBXMPSI_me, file = "Results/measurement_real_voi/LBXMPSI_me.RData")
...
save(LBXSCA_me, file = "Results/measurement_real_voi/LBXSCA_me.RData")
...
save(LBXSNASI_me, file = "Results/measurement_real_voi/LBXSNASI_me.RData")
...
save(LBXSOSSI_me, file = "Results/measurement_real_voi/LBXSOSSI_me.RData")
...
save(LBXSPH_me, file = "Results/measurement_real_voi/LBXSPH_me.RData")
...
save(male_me, file = "Results/measurement_real_voi/male_me.RData")
...
save(pest_control_home_last_month_me, 
     file = "Results/measurement_real_voi/pest_control_home_last_month_me.RData")
...
save(pneu_me, file = "Results/measurement_real_voi/pneu_me.RData")
...
save(private_water_source_me, file = "Results/measurement_real_voi/private_water_source_me.RData")
...
save(use_water_treatment_me, file = "Results/measurement_real_voi/use_water_treatment_me.RData")
...
RIDAGEYR_me <- me_fun(data = mainTab, ord_var = data_ord, voi = "RIDAGEYR", voi_type = "Num", 
                      me_type = "voi", me_range = me_mix, adj_var = adj_var, adj_type = adj_type, 
                      B = 1000, print_progress = T)

save(RIDAGEYR_me, file = "Results/measurement_real_voi/RIDAGEYR_me.RData")
...
save(SMD410_me, file = "Results/measurement_real_voi/SMD410_me.RData")